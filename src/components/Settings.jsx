...
const GUIDE = [
  ...
  },
  {
    ...
    items: [
      ...
      ['Removing a phone model leaves the Models screen usable', 'After you remove the current model, the phone closes that detail sheet cleanly and Home stops offering weights that are no longer installed. Your conversations stay on the phone.'],
